function fin_param = analytical_gradient(cuboid, P, T, visible_pt_3d, depth_map)
    ...
    activation_label = [0 1 0 0 0 0]; activation_label = (activation_label == 1); activated_params_num = 1;
