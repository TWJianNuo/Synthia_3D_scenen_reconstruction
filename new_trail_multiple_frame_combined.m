...
function cubic_record_entry = optimize_for_single_obj_set(cubic_record_entry, objs, depth_cluster, frame_num, obj_ind)
    ...
    % load('/home/ray/ShengjieZhu/Fall Semester/depth_detection_project/Exp_re/cubic_shape_estimation/single_frame_exp_record3/4_5.mat');
    ...
    for i = 1 : it_num
        ...
        if ~isempty(t_objs)
            ...
            % for j = 3 : 3
                ...
                % visualize_inner_sit(cuboid, t_objs{j}, depth_map, visible_pts(t_counts_set(j,:), :), activation_label, objs{1}.affine_matrx)
...
function visualize_inner_sit(cuboid, cur_obj, depth_map, visible_pts, activation_label)
    ...
    hold on; scatter3(pts_3d(:,1), pts_3d(:,2), pts_3d(:,3), 40, 'k', 'fill')
end
