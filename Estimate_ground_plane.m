function Estimate_ground_plane()
    % Road  3
    frame = 1;
    ...
    reconstructed_3d{frame} = get_3d_pts(depth, extrinsic_params, intrinsic_params, linear_ind);
    [affine_matrx, mean_error] = estimate_origin_ground_plane(reconstructed_3d{frame});
